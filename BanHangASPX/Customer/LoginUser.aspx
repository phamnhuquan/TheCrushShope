<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginUser.aspx.cs" Inherits="BanHangASPX.LoginUser" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>TheCrush login</title>
    <meta charset="UTF-8">
        ...
        <div class="container-login100" style="background-image: url('./img/product/shope-add22.jpg');">
            <div class="wrap-login100 p-t-70 p-b-30">
                <form class="login100-form validate-form" runat="server">
                    ...
                    <span class="login100-form-title p-t-20 p-b-45">Welcome to TheCrush Shop
                    </span>
                    ...
                    <div class="text-center w-full p-t-25 p-b">
                        <a href="register.aspx" class="txt1">Register here
                        </a>
                    </div>
                </form>
            </div>
